		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MAF Worklist Free Style",
									"targetURL": "#MAFWorklistFreeStyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MAFWorklistFreeStyle-display": {
								"semanticObject": "MAFWorklistFreeStyle",
								"action": "display",
								"description": "MAF Worklist Free Style",
								"title": "MAF Worklist Free Style",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=maffreeworklist",
									"url": sap.ui.require.toUrl("maffreeworklist")
								}
							}
						}
					}
