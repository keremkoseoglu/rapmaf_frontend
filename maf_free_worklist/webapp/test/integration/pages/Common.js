sap.ui.define([
	...
	return Opa5.extend("maffreeworklist.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["maffreeworklist/localService/mockserver"], function (mockserver) {
